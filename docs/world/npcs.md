...
Check yours with `/relationships`. [Caelen's daily quests](../guilds/quests.md#the-story-line) are one reliable way to grow a bond.
...
| --- | --- |
| `/relationships` | Your bonds with story NPCs, with named tiers |
| `/affinity` | Your overall reputation (aliases `/rep`, `/reputation`) |
