...
- **[Classes](progression/classes.md)** — pick a class, then unlock advanced ones with Class Tokens.
...
- **[The Market](economy/market.md)** — the server shop, auction house, and the player-run economy.

## Everything else

| Section | What's in it |
| --- | --- |
| [Dungeons & Parties](adventure/dungeons.md) | Instanced runs, walk-in World Dungeons, parties, leaderboards |
...
| [Crafting & Item Quality](economy/crafting.md) | The Forged-By system and how your profession level shapes gear |
